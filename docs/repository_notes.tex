...
Small-worldness & \(\sigma_{\mathrm{ER}}=3.49\) (scored); \(\sigma_{\mathrm{dp}}=2.30\) & \(\sigma_{\mathrm{ER}}=3.41\) (scored); \(\sigma_{\mathrm{dp}}=2.22\) & PASS \\
...
Small-worldness & \(\sigma_{\rm ER}=2.880\) (scored); \(\sigma_{\rm dp}=1.918\) & PASS\\
...
\emph{NeuroImage}, 160:73--83, 2017.
